...
# Read the JSON file
json_data <- fromJSON("3_preventative_multi_iter_100iters.json", simplifyVector = FALSE)
...
# Write to CSV
write.csv(summary_df, "3_preventative_multi_iter_summary_100iters.csv", row.names = FALSE)
...
write.csv(detailed_df, "preventive_results_detailed_rmse.csv", row.names = FALSE)
...
write.csv(comparison_table, "preventive_results_comparison_median_rmse.csv", row.names = FALSE)
...
write.csv(key_summary, "preventive_results_key_learners_median_rmse.csv", row.names = FALSE)
...
write.csv(learner_type_summary, "preventive_results_by_type_median_rmse.csv", row.names = FALSE)
...
write.csv(rmse_ranking, "preventive_results_rmse_ranking_median.csv", row.names = FALSE)
...
cat("  1. preventive_results_summary_median_rmse.csv - Main summary with median RMSE\n")
cat("  2. preventive_results_detailed_rmse.csv - All iterations with RMSE column\n")
cat("  3. preventive_results_comparison_median_rmse.csv - Formatted comparison table\n")
cat("  4. preventive_results_key_learners_median_rmse.csv - Subset of key learners\n")
cat("  5. preventive_results_by_type_median_rmse.csv - Aggregated by learner type\n")
cat("  6. preventive_results_rmse_ranking_median.csv - Ranking by median RMSE\n")